...
public class GeneratorUtil {
     ...
     * @throws IOException
     */
    public static String generate(VelocityContext velocityCtx, String templateFile, String database) {
        StringWriter stringWriter = null;
        try {
            templateFile = Constants.TEMPLATE_PATH + Constants.FILE_SEPERATOR + "/" + database + "/" + templateFile;
//			logger.debug(templateFile);
    ...
    public static String getFieldJavaType(Column col) {
        ...
        if (col.getDataType().equals("NUMBER")) {
            ...
            javaType = "Integer";
        } else if (col.getDataType().equals("datetime") ||
                col.getDataType().startsWith("timestamp")) {
            javaType = "Date";
        }else if (col.getDataType().equals("varchar")) {
            javaType = "String";
        } else {
            javaType = "String";
        }
