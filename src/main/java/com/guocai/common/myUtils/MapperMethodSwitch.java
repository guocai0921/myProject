...
public class MapperMethodSwitch {
	 ...
	 */
	private boolean enableDeleteAllByPrimaryKey=true;
	/**
	 * 生成deleteAllByPrimaryKey语句开关
	 */
	 ...
	 * 生成insertAll语句开关
	 */
	private boolean enableInsertAll = true;
	/**
	 * 生成update语句开关
	 */
	 ...
	 * 生成updateAll语句开关
	 */
	private boolean enableUpdateAll = true;
	/**
	 * 生成树形递归查询语句
	 */
	private boolean enableFindTree = true;
